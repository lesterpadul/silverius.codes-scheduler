...
ActiveRecord::Schema.define(version: 2021_09_24_141017) do
  ...
  create_table "donation_stats", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "user_id"
    ...
    t.index ["user_id"], name: "index_donation_stats_on_user_id"
  end
  ...
  create_table "donations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["target_id"], name: "index_donations_on_target_id"
